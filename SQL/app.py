...
INGECTION_WARNING = """
                    SQL agent can be vulnerable to prompt injection. Use a DB role with limited Permision
                    """
LOCALDB = "USE_LOCALDB"
MYSQL = "USE_MYSQL"
...
if "messages" not in st.session_state or st.sidebar.button("Clear messag history"):
